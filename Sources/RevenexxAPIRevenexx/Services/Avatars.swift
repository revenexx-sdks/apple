...
open class Avatars: Service {
    ...
    ///
    /// - Parameters:
    ///   - code: Revenexx API — revenexxEnums.Code
    ///   - width: Int (optional)
    ///   - height: Int (optional)
    ...
    /// - Returns: Any
    ///
    open func avatarsGetFavicon(
        url: String
    ) async throws -> Any {
        let apiPath: String = "/v1/avatars/favicon"
    ...
    ///   - theme: Revenexx API — revenexxEnums.Theme (optional)
    ///   - userAgent: String (optional)
    ///   - fullpage: Bool (optional)
    ///   - locale: String (optional)
    ///   - timezone: Revenexx API — revenexxEnums.Timezone (optional)
    ///   - latitude: Double (optional)
    ///   - longitude: Double (optional)
    ///   - accuracy: Double (optional)
    ///   - touch: Bool (optional)
    ///   - permissions: [Revenexx API — revenexxEnums.Permissions] (optional)
    ///   - sleep: Int (optional)
    ///   - width: Int (optional)
    ///   - height: Int (optional)
    ///   - quality: Int (optional)
    ///   - output: Revenexx API — revenexxEnums.Output (optional)
    /// - Throws: Exception if the request fails
    /// - Returns: Any
    ///
    open func avatarsGetScreenshot(
        ...
        scale: Double? = nil,
        theme: Revenexx API — revenexxEnums.Theme? = nil,
        userAgent: String? = nil,
        fullpage: Bool? = nil,
        locale: String? = nil,
        timezone: Revenexx API — revenexxEnums.Timezone? = nil,
        latitude: Double? = nil,
        longitude: Double? = nil,
        accuracy: Double? = nil,
        touch: Bool? = nil,
        permissions: [Revenexx API — revenexxEnums.Permissions]? = nil,
        sleep: Int? = nil,
        width: Int? = nil,
        height: Int? = nil,
        quality: Int? = nil,
        output: Revenexx API — revenexxEnums.Output? = nil
    ) async throws -> Any {
