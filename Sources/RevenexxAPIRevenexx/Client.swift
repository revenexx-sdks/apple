...
@_exported import RevenexxAPIRevenexxModels
   ...
   open func ping() async throws -> String {
    ...
    private func execute<T>(
        ...
        default:
            ...
            throw RevenexxAPIRevenexxError(
                message: message,
    ...
    func chunkedUpload<T>(
        ...
        while offset < size {
            ...
            headers["x-revenexx api — revenexx-id"] = result["$id"] as? String
    ...
    private func addOriginHeader() {
        ...
        _ = addHeader(
            key: "origin",
            value: "revenexx api — revenexx-\(operatingSystem)://\(packageInfo.packageName)"
        )
    }
}
