...
open class ColumnFloat: Codable {
    ...
    public let status: RevenexxEnums.ColumnFloatStatus
    /// Column type.
    ...
    init(
        ...
        min: Double?,
        `required`: Bool,
        status: RevenexxEnums.ColumnFloatStatus,
        type: String
    ) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        self.status = RevenexxEnums.ColumnFloatStatus(rawValue: try container.decode(String.self, forKey: .status))!
