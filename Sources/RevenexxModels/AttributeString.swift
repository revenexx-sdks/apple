...
open class AttributeString: Codable {
    ...
    public let status: RevenexxEnums.AttributeStringStatus
    /// Attribute type.
    ...
    init(
        ...
        `required`: Bool,
        size: Int,
        status: RevenexxEnums.AttributeStringStatus,
        type: String
    ) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        self.status = RevenexxEnums.AttributeStringStatus(rawValue: try container.decode(String.self, forKey: .status))!
