...
open class ContactEventKind: Codable {
    ...
    public let tone: RevenexxEnums.ContactEventKindTone?
    ...
    init(
        ...
        tenant_id: String?,
        title: String?,
        tone: RevenexxEnums.ContactEventKindTone?,
        updated_at: String?
    ) {
        self.code = code
    ...
    public required init(from decoder: Decoder) throws {
        ...
        if let toneString = try container.decodeIfPresent(String.self, forKey: .tone) {
            self.tone = RevenexxEnums.ContactEventKindTone(rawValue: toneString)
        } else {
            self.tone = nil
        }
    ...
    public static func from(map: [String: Any] ) -> ContactEventKind {
        return ContactEventKind(
            ...
            tone: map["tone"] as? String != nil ? ContactEventKindTone(rawValue: map["tone"] as! String) : nil,
