...
open class ContactEventKindUpdateRequest: Codable {
    ...
    public let tone: RevenexxEnums.ContactEventKindUpdateRequestTone?
    ...
    init(
        ...
        position: Int?,
        title: String?,
        tone: RevenexxEnums.ContactEventKindUpdateRequestTone?
    ) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        if let toneString = try container.decodeIfPresent(String.self, forKey: .tone) {
            self.tone = RevenexxEnums.ContactEventKindUpdateRequestTone(rawValue: toneString)
        } else {
            self.tone = nil
        }
    }
    ...
    public static func from(map: [String: Any] ) -> ContactEventKindUpdateRequest {
        return ContactEventKindUpdateRequest(
            ...
            tone: map["tone"] as? String != nil ? ContactEventKindUpdateRequestTone(rawValue: map["tone"] as! String) : nil
        )
    }
}
