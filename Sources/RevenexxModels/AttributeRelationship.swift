...
open class AttributeRelationship: Codable {
    ...
    public let status: RevenexxEnums.AttributeRelationshipStatus
    ...
    init(
        ...
        `required`: Bool,
        side: String,
        status: RevenexxEnums.AttributeRelationshipStatus,
        twoWay: Bool,
        twoWayKey: String,
        type: String
    ) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        self.status = RevenexxEnums.AttributeRelationshipStatus(rawValue: try container.decode(String.self, forKey: .status))!
