...
open class MultiSearchEntry<T : Codable>: Codable {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        self.collection_name = try container.decodeIfPresent(String.self, forKey: .collection_name)
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(collection_name, forKey: .collection_name)
    ...
    public func toMap() -> [String: Any] {
        return [
            "collection_name": collection_name as Any,
    ...
    public static func from(map: [String: Any] ) -> MultiSearchEntry {
