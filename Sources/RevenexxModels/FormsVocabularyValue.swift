...
/// 
open class FormsVocabularyValue: Codable {
    ...
    public let tone: RevenexxEnums.FormsVocabularyTone?
    ...
    init(
        ...
        tone: RevenexxEnums.FormsVocabularyTone?
    ) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        if let toneString = try container.decodeIfPresent(String.self, forKey: .tone) {
            self.tone = RevenexxEnums.FormsVocabularyTone(rawValue: toneString)
        } else {
            self.tone = nil
        }
    }
    ...
    public static func from(map: [String: Any] ) -> FormsVocabularyValue {
        return FormsVocabularyValue(
            ...
            tone: map["tone"] as? String != nil ? FormsVocabularyTone(rawValue: map["tone"] as! String) : nil
        )
    }
}
