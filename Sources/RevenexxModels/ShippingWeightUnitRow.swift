...
/// 
open class ShippingWeightUnitRow: Codable {
    ...
    public let tone: RevenexxEnums.ShippingWeightUnitRowTone?
    ...
    init(
        ...
        position: Int?,
        title: String?,
        tone: RevenexxEnums.ShippingWeightUnitRowTone?,
        updated_at: String?
    ) {
        self.code = code
    ...
    public required init(from decoder: Decoder) throws {
        ...
        if let toneString = try container.decodeIfPresent(String.self, forKey: .tone) {
            self.tone = RevenexxEnums.ShippingWeightUnitRowTone(rawValue: toneString)
        } else {
            self.tone = nil
        }
    ...
    public static func from(map: [String: Any] ) -> ShippingWeightUnitRow {
        return ShippingWeightUnitRow(
            ...
            tone: map["tone"] as? String != nil ? ShippingWeightUnitRowTone(rawValue: map["tone"] as! String) : nil,
