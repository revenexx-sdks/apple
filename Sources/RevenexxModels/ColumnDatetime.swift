...
open class ColumnDatetime: Codable {
    ...
    public let status: RevenexxEnums.ColumnDatetimeStatus
    /// Column type.
    ...
    init(
        ...
        key: String,
        `required`: Bool,
        status: RevenexxEnums.ColumnDatetimeStatus,
        type: String
    ) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        self.status = RevenexxEnums.ColumnDatetimeStatus(rawValue: try container.decode(String.self, forKey: .status))!
