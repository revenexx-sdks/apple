...
open class AssetFamiliesFilter<T : Codable>: Codable {
    ...
    public let naming_convention: String?
    ...
    public required init(from decoder: Decoder) throws {
        ...
        self.naming_convention = try container.decodeIfPresent(String.self, forKey: .naming_convention)
    ...
    public static func from(map: [String: Any] ) -> AssetFamiliesFilter {
