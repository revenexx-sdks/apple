...
open class PaymentTermCreateRequest: Codable {
    ...
    public let tone: RevenexxEnums.PaymentTermCreateRequestTone?
    ...
    init(
        ...
        position: Int?,
        title: String,
        tone: RevenexxEnums.PaymentTermCreateRequestTone?
    ) {
        self.code = code
    ...
    public required init(from decoder: Decoder) throws {
        ...
        if let toneString = try container.decodeIfPresent(String.self, forKey: .tone) {
            self.tone = RevenexxEnums.PaymentTermCreateRequestTone(rawValue: toneString)
        } else {
            self.tone = nil
        }
    }
    ...
    public static func from(map: [String: Any] ) -> PaymentTermCreateRequest {
        return PaymentTermCreateRequest(
            ...
            tone: map["tone"] as? String != nil ? PaymentTermCreateRequestTone(rawValue: map["tone"] as! String) : nil
        )
    }
}
