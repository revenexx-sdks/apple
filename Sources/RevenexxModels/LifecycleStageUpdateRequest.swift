...
open class LifecycleStageUpdateRequest: Codable {
    ...
    public let tone: RevenexxEnums.LifecycleStageUpdateRequestTone?
    ...
    init(
        ...
        position: Int?,
        title: String?,
        tone: RevenexxEnums.LifecycleStageUpdateRequestTone?
    ) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        if let toneString = try container.decodeIfPresent(String.self, forKey: .tone) {
            self.tone = RevenexxEnums.LifecycleStageUpdateRequestTone(rawValue: toneString)
        } else {
            self.tone = nil
        }
    }
    ...
    public static func from(map: [String: Any] ) -> LifecycleStageUpdateRequest {
        return LifecycleStageUpdateRequest(
            ...
            tone: map["tone"] as? String != nil ? LifecycleStageUpdateRequestTone(rawValue: map["tone"] as! String) : nil
        )
    }
}
