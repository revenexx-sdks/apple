...
open class PaymentTermUpdateRequest: Codable {
    ...
    public let tone: RevenexxEnums.PaymentTermUpdateRequestTone?
    ...
    init(
        ...
        position: Int?,
        title: String?,
        tone: RevenexxEnums.PaymentTermUpdateRequestTone?
    ) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        if let toneString = try container.decodeIfPresent(String.self, forKey: .tone) {
            self.tone = RevenexxEnums.PaymentTermUpdateRequestTone(rawValue: toneString)
        } else {
            self.tone = nil
        }
    }
    ...
    public static func from(map: [String: Any] ) -> PaymentTermUpdateRequest {
        return PaymentTermUpdateRequest(
            ...
            tone: map["tone"] as? String != nil ? PaymentTermUpdateRequestTone(rawValue: map["tone"] as! String) : nil
        )
    }
}
