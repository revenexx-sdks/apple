...
open class ColumnRelationship: Codable {
    ...
    public let status: RevenexxEnums.ColumnRelationshipStatus
    ...
    init(
        ...
        `required`: Bool,
        side: String,
        status: RevenexxEnums.ColumnRelationshipStatus,
        twoWay: Bool,
        twoWayKey: String,
        type: String
    ) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        self.status = RevenexxEnums.ColumnRelationshipStatus(rawValue: try container.decode(String.self, forKey: .status))!
