...
open class AttributeFloat: Codable {
    ...
    public let status: RevenexxEnums.AttributeFloatStatus
    /// Attribute type.
    ...
    init(
        ...
        min: Double?,
        `required`: Bool,
        status: RevenexxEnums.AttributeFloatStatus,
        type: String
    ) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        self.status = RevenexxEnums.AttributeFloatStatus(rawValue: try container.decode(String.self, forKey: .status))!
