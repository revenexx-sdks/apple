...
open class ShippingWeightUnitUpdateRequest: Codable {
    ...
    public let tone: RevenexxEnums.ShippingWeightUnitUpdateRequestTone?
    ...
    init(
        ...
        position: Int?,
        title: String?,
        tone: RevenexxEnums.ShippingWeightUnitUpdateRequestTone?
    ) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        if let toneString = try container.decodeIfPresent(String.self, forKey: .tone) {
            self.tone = RevenexxEnums.ShippingWeightUnitUpdateRequestTone(rawValue: toneString)
        } else {
            self.tone = nil
        }
    }
    ...
    public static func from(map: [String: Any] ) -> ShippingWeightUnitUpdateRequest {
        return ShippingWeightUnitUpdateRequest(
            ...
            tone: map["tone"] as? String != nil ? ShippingWeightUnitUpdateRequestTone(rawValue: map["tone"] as! String) : nil
        )
    }
}
