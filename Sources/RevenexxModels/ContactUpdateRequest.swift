...
open class ContactUpdateRequest: Codable {
    ...
    public let registration_status: RevenexxEnums.ContactUpdateRequestRegistrationStatus?
    ...
    init(
        ...
        phone: String?,
        registration_status: RevenexxEnums.ContactUpdateRequestRegistrationStatus?,
        role: String?,
    ...
    public required init(from decoder: Decoder) throws {
        ...
        if let registration_statusString = try container.decodeIfPresent(String.self, forKey: .registration_status) {
            self.registration_status = RevenexxEnums.ContactUpdateRequestRegistrationStatus(rawValue: registration_statusString)
        } else {
    ...
    public static func from(map: [String: Any] ) -> ContactUpdateRequest {
        return ContactUpdateRequest(
            ...
            registration_status: map["registration_status"] as? String != nil ? ContactUpdateRequestRegistrationStatus(rawValue: map["registration_status"] as! String) : nil,
