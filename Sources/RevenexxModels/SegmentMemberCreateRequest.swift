...
open class SegmentMemberCreateRequest: Codable {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        self.organization_id = try container.decode(String.self, forKey: .organization_id)
        self.segment_id = try container.decode(String.self, forKey: .segment_id)
    ...
    public static func from(map: [String: Any] ) -> SegmentMemberCreateRequest {
