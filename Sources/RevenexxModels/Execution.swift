...
open class Execution: Codable {
    ...
    public let status: RevenexxEnums.ExecutionStatus
    /// The trigger that caused the function to execute. Possible values can be: `http`, `schedule`, or `event`.
    public let trigger: RevenexxEnums.ExecutionTrigger
    ...
    init(
        ...
        scheduledAt: String?,
        status: RevenexxEnums.ExecutionStatus,
        trigger: RevenexxEnums.ExecutionTrigger
    ) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        self.status = RevenexxEnums.ExecutionStatus(rawValue: try container.decode(String.self, forKey: .status))!
        self.trigger = RevenexxEnums.ExecutionTrigger(rawValue: try container.decode(String.self, forKey: .trigger))!
    }
