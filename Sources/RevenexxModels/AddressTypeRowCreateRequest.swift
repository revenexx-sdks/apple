...
open class AddressTypeRowCreateRequest: Codable {
    ...
    public let tone: RevenexxEnums.AddressTypeRowCreateRequestTone?
    ...
    init(
        ...
        position: Int?,
        title: String,
        tone: RevenexxEnums.AddressTypeRowCreateRequestTone?
    ) {
        self.code = code
    ...
    public required init(from decoder: Decoder) throws {
        ...
        if let toneString = try container.decodeIfPresent(String.self, forKey: .tone) {
            self.tone = RevenexxEnums.AddressTypeRowCreateRequestTone(rawValue: toneString)
        } else {
            self.tone = nil
        }
    }
    ...
    public static func from(map: [String: Any] ) -> AddressTypeRowCreateRequest {
        return AddressTypeRowCreateRequest(
            ...
            tone: map["tone"] as? String != nil ? AddressTypeRowCreateRequestTone(rawValue: map["tone"] as! String) : nil
        )
    }
}
