...
/// 
open class OrderListWithItems: Codable {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        self.items = try container.decodeIfPresent([OrderListItem].self, forKey: .items)
    ...
    public static func from(map: [String: Any] ) -> OrderListWithItems {
        return OrderListWithItems(
            created_at: map["created_at"] as? String,
            id: map["id"] as? String,
            items: (map["items"] as? [[String: Any]] ?? []).map { OrderListItem.from(map: $0) },
