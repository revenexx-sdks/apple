...
/// 
open class CartConversion: Codable {
    ...
    public let pricing: CartConversionPricing?
    ...
    public let reservation: CartConversionReservation?
    ...
    public required init(from decoder: Decoder) throws {
        ...
        self.pricing = try container.decodeIfPresent(CartConversionPricing.self, forKey: .pricing)
        self.reservation = try container.decodeIfPresent(CartConversionReservation.self, forKey: .reservation)
    ...
    public func toMap() -> [String: Any] {
        return [
            ...
            "reservation": reservation?.toMap() as Any,
    ...
    public static func from(map: [String: Any] ) -> CartConversion {
        return CartConversion(
            ...
            pricing: CartConversionPricing.from(map: map["pricing"] as! [String: Any]),
            reservation: CartConversionReservation.from(map: map["reservation"] as! [String: Any]),
