...
open class Index: Codable {
    ...
    public let status: RevenexxEnums.IndexStatus
    /// Index type.
    ...
    init(
        ...
        lengths: [Int],
        orders: [String]?,
        status: RevenexxEnums.IndexStatus,
        type: String
    ) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        self.status = RevenexxEnums.IndexStatus(rawValue: try container.decode(String.self, forKey: .status))!
