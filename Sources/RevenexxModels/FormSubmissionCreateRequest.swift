...
/// 
open class FormSubmissionCreateRequest: Codable {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        self.form_id = try container.decode(String.self, forKey: .form_id)
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(form_id, forKey: .form_id)
    ...
    public static func from(map: [String: Any] ) -> FormSubmissionCreateRequest {
