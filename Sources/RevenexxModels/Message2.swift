...
open class Message2: Codable {
    ...
    /// Status of delivery.
    public let status: RevenexxEnums.Message2Status
    ...
    init(
        ...
        providerType: String,
        scheduledAt: String?,
        status: RevenexxEnums.Message2Status,
        targets: [String],
        topics: [String],
        users: [String]
    ) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        self.status = RevenexxEnums.Message2Status(rawValue: try container.decode(String.self, forKey: .status))!
    ...
    public static func from(map: [String: Any] ) -> Message2 {
        return Message2(
            ...
            status: Message2Status(rawValue: map["status"] as! String)!,
