...
open class OrderReturnCompleted: Codable {
    ...
    public let restock: [OrderRestockPosition]?
    ...
    public required init(from decoder: Decoder) throws {
        ...
        self.restock = try container.decodeIfPresent([OrderRestockPosition].self, forKey: .restock)
    ...
    public func toMap() -> [String: Any] {
        return [
            ...
            "restock": restock?.map { $0.toMap() } as Any,
            "status": status?.rawValue as Any,
            "updated_at": updated_at as Any
        ]
    }

    public static func from(map: [String: Any] ) -> OrderReturnCompleted {
        return OrderReturnCompleted(
            ...
            restock: (map["restock"] as? [[String: Any]] ?? []).map { OrderRestockPosition.from(map: $0) },
