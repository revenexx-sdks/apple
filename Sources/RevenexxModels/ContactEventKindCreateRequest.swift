...
open class ContactEventKindCreateRequest: Codable {
    ...
    public let tone: RevenexxEnums.ContactEventKindCreateRequestTone?
    ...
    init(
        ...
        position: Int?,
        title: String,
        tone: RevenexxEnums.ContactEventKindCreateRequestTone?
    ) {
        self.code = code
    ...
    public required init(from decoder: Decoder) throws {
        ...
        if let toneString = try container.decodeIfPresent(String.self, forKey: .tone) {
            self.tone = RevenexxEnums.ContactEventKindCreateRequestTone(rawValue: toneString)
        } else {
            self.tone = nil
        }
    }
    ...
    public static func from(map: [String: Any] ) -> ContactEventKindCreateRequest {
        return ContactEventKindCreateRequest(
            ...
            tone: map["tone"] as? String != nil ? ContactEventKindCreateRequestTone(rawValue: map["tone"] as! String) : nil
        )
    }
}
