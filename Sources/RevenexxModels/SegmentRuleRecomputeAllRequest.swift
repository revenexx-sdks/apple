...
/// No parameters — send {}.
open class SegmentRuleRecomputeAllRequest: Codable {
    ...
    public static func from(map: [String: Any] ) -> SegmentRuleRecomputeAllRequest {
        return SegmentRuleRecomputeAllRequest()
    }
}
