...
open class AttributeEnum: Codable {
    ...
    public let status: RevenexxEnums.AttributeEnumStatus
    /// Attribute type.
    ...
    init(
        ...
        key: String,
        `required`: Bool,
        status: RevenexxEnums.AttributeEnumStatus,
        type: String
    ) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        self.status = RevenexxEnums.AttributeEnumStatus(rawValue: try container.decode(String.self, forKey: .status))!
