...
open class AddressTypeRow: Codable {
    ...
    public let tone: RevenexxEnums.AddressTypeRowTone?
    ...
    init(
        ...
        tenant_id: String?,
        title: String?,
        tone: RevenexxEnums.AddressTypeRowTone?,
        updated_at: String?
    ) {
        self.code = code
    ...
    public required init(from decoder: Decoder) throws {
        ...
        if let toneString = try container.decodeIfPresent(String.self, forKey: .tone) {
            self.tone = RevenexxEnums.AddressTypeRowTone(rawValue: toneString)
        } else {
            self.tone = nil
        }
    ...
    public static func from(map: [String: Any] ) -> AddressTypeRow {
        return AddressTypeRow(
            ...
            tone: map["tone"] as? String != nil ? AddressTypeRowTone(rawValue: map["tone"] as! String) : nil,
