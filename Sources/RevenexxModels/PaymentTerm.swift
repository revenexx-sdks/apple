...
open class PaymentTerm: Codable {
    ...
    public let tone: RevenexxEnums.PaymentTermTone?
    ...
    init(
        ...
        tenant_id: String?,
        title: String?,
        tone: RevenexxEnums.PaymentTermTone?,
        updated_at: String?
    ) {
        self.code = code
    ...
    public required init(from decoder: Decoder) throws {
        ...
        if let toneString = try container.decodeIfPresent(String.self, forKey: .tone) {
            self.tone = RevenexxEnums.PaymentTermTone(rawValue: toneString)
        } else {
            self.tone = nil
        }
    ...
    public static func from(map: [String: Any] ) -> PaymentTerm {
        return PaymentTerm(
            ...
            tone: map["tone"] as? String != nil ? PaymentTermTone(rawValue: map["tone"] as! String) : nil,
