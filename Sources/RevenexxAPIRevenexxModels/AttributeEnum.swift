...
open class AttributeEnum: Codable {
    ...
    public let status: Revenexx API — revenexxEnums.AttributeEnumStatus
    /// Attribute type.
    ...
    init(
        ...
        key: String,
        `required`: Bool,
        status: Revenexx API — revenexxEnums.AttributeEnumStatus,
        type: String
    ) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        self.status = Revenexx API — revenexxEnums.AttributeEnumStatus(rawValue: try container.decode(String.self, forKey: .status))!
    ...
    public static func from(map: [String: Any] ) -> AttributeEnum {
        return AttributeEnum(
            ...
            status: AttributeEnumStatus(rawValue: map["status"] as! String)!,
