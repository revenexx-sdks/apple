...
open class ColumnString: Codable {
    ...
    public let status: Revenexx API — revenexxEnums.ColumnStringStatus
    /// Column type.
    ...
    init(
        ...
        `required`: Bool,
        size: Int,
        status: Revenexx API — revenexxEnums.ColumnStringStatus,
        type: String
    ) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        self.status = Revenexx API — revenexxEnums.ColumnStringStatus(rawValue: try container.decode(String.self, forKey: .status))!
