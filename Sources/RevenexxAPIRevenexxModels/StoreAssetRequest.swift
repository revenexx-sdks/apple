...
open class StoreAssetRequest: Codable {
    ...
    /// 
    public let visibility: Revenexx API — revenexxEnums.StoreAssetRequestVisibility?
    ...
    init(
        ...
        tags: [String]?,
        unpack: Bool?,
        visibility: Revenexx API — revenexxEnums.StoreAssetRequestVisibility?
    ) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        if let visibilityString = try container.decodeIfPresent(String.self, forKey: .visibility) {
            self.visibility = Revenexx API — revenexxEnums.StoreAssetRequestVisibility(rawValue: visibilityString)
        } else {
            self.visibility = nil
        }
    }
