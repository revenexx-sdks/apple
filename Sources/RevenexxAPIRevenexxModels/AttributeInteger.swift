...
open class AttributeInteger: Codable {
    ...
    public let status: Revenexx API — revenexxEnums.AttributeIntegerStatus
    /// Attribute type.
    ...
    init(
        ...
        min: Int?,
        `required`: Bool,
        status: Revenexx API — revenexxEnums.AttributeIntegerStatus,
        type: String
    ) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        self.status = Revenexx API — revenexxEnums.AttributeIntegerStatus(rawValue: try container.decode(String.self, forKey: .status))!
