...
open class AttributeFloat: Codable {
    ...
    public let status: Revenexx API — revenexxEnums.AttributeFloatStatus
    /// Attribute type.
    ...
    init(
        ...
        min: Double?,
        `required`: Bool,
        status: Revenexx API — revenexxEnums.AttributeFloatStatus,
        type: String
    ) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        self.status = Revenexx API — revenexxEnums.AttributeFloatStatus(rawValue: try container.decode(String.self, forKey: .status))!
    ...
    public static func from(map: [String: Any] ) -> AttributeFloat {
        return AttributeFloat(
            ...
            status: AttributeFloatStatus(rawValue: map["status"] as! String)!,
