...
open class ColumnInteger: Codable {
    ...
    public let status: Revenexx API — revenexxEnums.ColumnIntegerStatus
    /// Column type.
    ...
    init(
        ...
        min: Int?,
        `required`: Bool,
        status: Revenexx API — revenexxEnums.ColumnIntegerStatus,
        type: String
    ) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        self.status = Revenexx API — revenexxEnums.ColumnIntegerStatus(rawValue: try container.decode(String.self, forKey: .status))!
