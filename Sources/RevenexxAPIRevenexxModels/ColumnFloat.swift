...
open class ColumnFloat: Codable {
    ...
    public let status: Revenexx API — revenexxEnums.ColumnFloatStatus
    /// Column type.
    ...
    init(
        ...
        min: Double?,
        `required`: Bool,
        status: Revenexx API — revenexxEnums.ColumnFloatStatus,
        type: String
    ) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        self.status = Revenexx API — revenexxEnums.ColumnFloatStatus(rawValue: try container.decode(String.self, forKey: .status))!
    ...
    public static func from(map: [String: Any] ) -> ColumnFloat {
        return ColumnFloat(
            ...
            status: ColumnFloatStatus(rawValue: map["status"] as! String)!,
