...
open class ColumnText: Codable {
    ...
    public let status: Revenexx API — revenexxEnums.ColumnTextStatus
    /// Column type.
    ...
    init(
        ...
        key: String,
        `required`: Bool,
        status: Revenexx API — revenexxEnums.ColumnTextStatus,
        type: String
    ) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        self.status = Revenexx API — revenexxEnums.ColumnTextStatus(rawValue: try container.decode(String.self, forKey: .status))!
