...
open class Deployment: Codable {
    ...
    public let status: Revenexx API — revenexxEnums.DeploymentStatus
    ...
    init(
        ...
        sourceSize: Int,
        status: Revenexx API — revenexxEnums.DeploymentStatus,
        totalSize: Int,
        type: String
    ) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        self.status = Revenexx API — revenexxEnums.DeploymentStatus(rawValue: try container.decode(String.self, forKey: .status))!
